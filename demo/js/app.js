...
function switchTab(group, tabId) {
  document
    .querySelectorAll(`[data-tab-group="${group}"] .tab`)
    .forEach((t) => t.classList.remove("active"));
  document
    .querySelectorAll(`[data-tab-content="${group}"]`)
    .forEach((c) => (c.style.display = "none"));
  document
    .querySelector(`[data-tab-group="${group}"] [data-tab="${tabId}"]`)
...
function showToast(message, type = "success") {
  ...
  const icon =
    type === "success"
      ? '<svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="3" stroke-linecap="round" stroke-linejoin="round" style="vertical-align:middle"><polyline points="20 6 9 17 4 12"/></svg>'
      : type === "error"
        ? '<svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="3" stroke-linecap="round" stroke-linejoin="round" style="vertical-align:middle"><line x1="18" y1="6" x2="6" y2="18"/><line x1="6" y1="6" x2="18" y2="18"/></svg>'
        : '<svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" style="vertical-align:middle"><circle cx="12" cy="12" r="10"/><line x1="12" y1="16" x2="12" y2="12"/><line x1="12" y1="8" x2="12.01" y2="8"/></svg>';
...
const MOCK_PROJECTS = [
  {
    id: "1",
    clientId: "1",
    name: "ABC สาขาสยาม — Facebook",
    platform: "facebook",
    pageName: "ABC สาขาสยาม",
    posts: 20,
    scheduled: 5,
    published: 12,
    active: true,
...
const MOCK_POSTS = [
  {
    ...
    time: "10:00",
    content:
      "สงกรานต์นี้ ร้านอาหาร ABC จัดโปรสุดพิเศษ ลดทันที 30% ทุกเมนู! ตั้งแต่วันที่ 13-15 เมษายน 2569",
    hashtags: ["#สงกรานต์", "#ลด30", "#ABCrestaurant"],
  },
  {
    id: "2",
    title: "5 เมนูอาหารไทยยอดฮิต",
    tag: "education",
    status: "scheduled",
    type: "regular_post",
    date: "2026-03-17",
    time: "12:00",
    content:
      "มาทำความรู้จักกับ 5 เมนูอาหารไทยที่คนทั่วโลกหลงรัก 1. ต้มยำกุ้ง 2. ผัดไทย 3. แกงเขียวหวาน 4. ส้มตำ 5. มัสมั่น",
    hashtags: ["#อาหารไทย", "#ThaiFood", "#FoodLovers"],
  },
  {
    id: "3",
    title: "คุณชอบเมนูไหนมากที่สุด?",
    tag: "engagement",
    status: "draft",
    type: "engagement",
    date: "2026-03-18",
    time: "18:00",
    content:
      "วันนี้มาโหวตกัน! คุณชอบเมนูไหนมากที่สุด? A. ต้มยำกุ้ง B. ผัดไทย C. แกงเขียวหวาน D. ส้มตำ",
    hashtags: ["#โหวต", "#อาหารไทย"],
  },
  {
    id: "4",
    title: "แชร์บทความ เทรนด์อาหาร 2026",
    tag: "education",
    status: "scheduled",
    type: "article_share",
    date: "2026-03-19",
    time: "09:00",
    content: "เทรนด์อาหารปี 2026 ที่ร้านอาหารต้องรู้! อ่านบทความเต็มที่เว็บไซต์ของเรา",
    hashtags: ["#FoodTrend2026", "#RestaurantBusiness"],
  },
  {
    id: "5",
    title: "รีวิวจากลูกค้า คุณแอน",
    tag: "testimonial",
    status: "published",
    type: "regular_post",
    date: "2026-03-14",
    time: "15:00",
    content: '"อาหารอร่อยมาก บรรยากาศดี พนักงานบริการเยี่ยม จะมาอีกแน่นอนค่ะ" — คุณแอน ลูกค้าประจำ',
    hashtags: ["#รีวิว", "#ABCrestaurant", "#Testimonial"],
  },
  {
    id: "6",
    title: "วันสงกรานต์ร่วมสืบสานประเพณี",
    tag: "seasonal",
    status: "scheduled",
    type: "regular_post",
    date: "2026-03-20",
    time: "08:00",
    content: "สุขสันต์วันสงกรานต์ค่ะ ร้าน ABC ขอร่วมสืบสานประเพณีไทย",
    hashtags: ["#สงกรานต์", "#ประเพณีไทย"],
  },
  {
    id: "7",
    title: "Brand Story ทำไมเราถึงเลือกใช้วัตถุดิบท้องถิ่น",
    tag: "branding",
    status: "draft",
    type: "regular_post",
    date: "2026-03-21",
    time: "11:00",
    content:
      "ที่ร้าน ABC เราเชื่อว่าวัตถุดิบที่ดีคือจุดเริ่มต้นของอาหารที่ดี เราเลือกใช้วัตถุดิบท้องถิ่นจากเกษตรกรไทย",
    hashtags: ["#BrandStory", "#LocalIngredients", "#ABCrestaurant"],
  },
  {
    id: "8",
    title: "ผลโพสต์ล้มเหลว Connection timeout",
    tag: "promotion",
    status: "failed",
    type: "promotion",
    date: "2026-03-16",
    time: "14:00",
    content: "โปรโมชั่นพิเศษ ซื้อ 1 แถม 1",
    hashtags: ["#โปรโมชั่น"],
  },
];
...
const MOCK_LOGS = [
  {
    postTitle: "โปรโมชั่นสงกรานต์ ลด 30%",
    platform: "facebook",
    status: "success",
    date: "15 มี.ค. 2569 10:02",
    postId: "fb_123456",
    error: null,
  },
  {
    postTitle: "รีวิวจากลูกค้า คุณแอน",
    platform: "facebook",
    status: "success",
    date: "14 มี.ค. 2569 15:03",
    postId: "fb_123455",
    error: null,
  },
  {
    postTitle: "ผลโพสต์ล้มเหลว Connection timeout",
    platform: "facebook",
    status: "failed",
    date: "16 มี.ค. 2569 14:01",
    postId: null,
    error: "Connection timeout after 30s — VPS unreachable",
    retry: 2,
  },
  {
    postTitle: "โปรโมชั่นสงกรานต์ ลด 30%",
...
function simulateAIGenerate(btn) {
  ...
  setTimeout(() => {
    btn.disabled = false;
    btn.innerHTML =
      '<svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" style="vertical-align:middle"><polygon points="12 2 15.09 8.26 22 9.27 17 14.14 18.18 21.02 12 17.77 5.82 21.02 7 14.14 2 9.27 8.91 8.26 12 2"/></svg> Generate ด้วย AI';
    resultEl.innerHTML = `
...
function simulateMonthlyPlan(btn) {
  ...
  // Show loading
  preview.innerHTML =
    '<div style="padding:2rem;text-align:center;color:var(--text-muted)"><div class="ai-loading" style="width:60%;margin:0 auto 1rem"></div><div class="ai-loading" style="width:80%;margin:0 auto 1rem"></div><div class="ai-loading" style="width:70%;margin:0 auto"></div><p style="margin-top:1rem">AI กำลังวิเคราะห์ Brand Profile และสร้างแผนรายเดือน...</p></div>';

  setTimeout(() => {
    btn.disabled = false;
    btn.innerHTML =
      '<svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" style="vertical-align:middle"><polygon points="12 2 15.09 8.26 22 9.27 17 14.14 18.18 21.02 12 17.77 5.82 21.02 7 14.14 2 9.27 8.91 8.26 12 2"/></svg> Generate แผนรายเดือน';
    ...
    const planSlots = [
      ...
      },
      {
        ...
        day: "พุธ",
        type: "engagement",
        topic: "โหวต เมนูสงกรานต์ที่คุณอยากลอง?",
        time: "12:00",
      },
      {
        date: "11 เม.ย.",
        day: "ศุกร์",
        type: "branding",
        topic: "เรื่องราวความตั้งใจของเชฟ ABC",
        time: "10:00",
      },
      {
        date: "11 เม.ย.",
        day: "ศุกร์",
        type: "education",
        topic: "แชร์บทความ เทรนด์อาหาร 2026",
        time: "15:00",
      },
      {
        date: "12 เม.ย.",
        day: "เสาร์",
        type: "promotion",
        topic: "โปรสงกรานต์ ลด 30% ทุกเมนู!",
        time: "09:00",
      },
      {
        date: "14 เม.ย.",
        day: "จันทร์",
        type: "seasonal",
        topic: "สวัสดีปีใหม่ไทย! รดน้ำขอพรผู้ใหญ่",
        time: "08:00",
      },
      {
        date: "16 เม.ย.",
        day: "พุธ",
        type: "testimonial",
        topic: 'รีวิวจากลูกค้า "อาหารอร่อย บรรยากาศดี"',
        time: "12:00",
      },
      {
        date: "18 เม.ย.",
        day: "ศุกร์",
        type: "education",
        topic: "วิธีทำต้มยำกุ้งแบบต้นตำรับ",
        time: "10:00",
      },
    ];
