-- ═══════════════════════════════════════════════════════════════
-- PostMate AI — Full Database Setup
-- ═══════════════════════════════════════════════════════════════
--
-- HOW TO USE:
--   1. Go to https://supabase.com/dashboard
--   2. Open your project (xkvuatexzcjdjkqfhpwi)
--   3. Navigate to "SQL Editor" in the left sidebar
--   4. Click "+ New query"
--   5. Paste this ENTIRE file
--   6. Click "Run" (Ctrl+Enter / Cmd+Enter)
--
-- IMPORTANT: This is idempotent-safe — uses IF NOT EXISTS where
-- possible, but if tables already exist, DROP them first or
...
CREATE TABLE monthly_plan_configs (
  ...
  active_days           int[] NOT NULL,      -- [1,3,5,6] = Mon,Wed,Fri,Sat
...
-- STORAGE BUCKETS
-- ─────────────────────────────────────────
-- Create storage buckets for media uploads and screenshots
...
-- Service role can manage screenshots
